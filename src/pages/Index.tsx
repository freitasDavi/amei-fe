                    ...
                    <div className="flex flex-wrap justify-between items-center mx-auto max-w-screen-xl">
                        ...
                        <div className="hidden justify-between items-center w-full lg:flex lg:w-auto lg:order-1" id="mobile-menu-2">
                            <ul className="flex flex-col mt-4 font-medium lg:flex-row lg:space-x-8 lg:mt-0">
                                <li>
                                    <a href="#" className="block py-2 pr-4 pl-3 text-white rounded bg-primary-logo lg:bg-transparent lg:text-primary-logo-dark lg:p-0 dark:text-white" aria-current="page">Home</a>
                                </li>
                                <li>
            ...
            <section className="bg-white dark:bg-gray-900">
                <div className="py-8 px-4 mx-auto max-w-screen-xl text-center lg:py-16 lg:px-12">
                    <a href="#" className="inline-flex justify-between items-center py-1 px-1 pr-4 mb-7 text-sm text-gray-700 bg-gray-100 rounded-full dark:bg-gray-800 dark:text-white hover:bg-gray-200 dark:hover:bg-gray-700" role="alert">
                        <span className="text-xs bg-primary-logo rounded-full text-white px-4 py-1.5 mr-3">Novo</span> <span className="text-sm font-medium">ERP a-mei acabou de sair! Veja o que temos de novo</span>
            ...
            <section className="w-full bg-white dark:bg-gray-900">
                <div className="py-8 px-4 mx-auto max-w-screen-xl lg:py-16 lg:px-6">
                    ...
                    <div className="space-y-8 lg:grid lg:grid-cols-3 sm:gap-6 xl:gap-10 lg:space-y-0">
                        ...
                        {/* <!-- Pricing Card --> */}
                        <PriceCard title="Company" price={99} description="Relevant for multiple users, extended & premium support." />
                        {/* <!-- Pricing Card --> */}
                        <PriceCard title="Enterprise" price={499} description="Best for large scale uses and extended redistribution rights." />
