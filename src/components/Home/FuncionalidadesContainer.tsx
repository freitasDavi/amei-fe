import { Alarm, ChartBar, Notepad, Receipt, Users } from "@phosphor-icons/react";



export function FuncionalidadesContainer() {
    return (
        <section id="functions" className="bg-white dark:bg-gray-900">
            <div className="py-8 px-4 mx-auto max-w-screen-xl sm:py-16 lg:px-6">
                <div className="max-w-screen-md mb-8 lg:mb-16">
                    <h2 className="mb-4 text-4xl tracking-tight font-extrabold text-gray-800 dark:text-white">A solução para os problemas gerenciais do seu negócio!</h2>
                    <p className="text-gray-500 sm:text-xl dark:text-gray-400">Veja algumas de nossas funcionalidades:</p>
                </div>
                <div className="space-y-8 md:grid md:grid-cols-2 md:gap-12 md:space-y-0">
                    <div>
                        <div className="flex justify-center items-center mb-4 w-10 h-10 rounded-full bg-primary-100 lg:h-12 lg:w-12 dark:bg-primary-900">
                            <Receipt size={32} color='#1C9AEA' weight='bold' />
                        ...
                        <h3 className="mb-2 text-xl font-bold dark:text-white">Nota Fiscal</h3>
                        <p className="text-gray-500 dark:text-gray-400">Realize a emissão de sua Nota Fiscal por meio de integração com o Portal do MEI.</p>
                    </div>
                    <div>
                        <div className="flex justify-center items-center mb-4 w-10 h-10 rounded-full bg-primary-100 lg:h-12 lg:w-12 dark:bg-primary-900">
                            <ChartBar size={32} weight="bold" color='#1C9AEA' />
                        ...
                        <h3 className="mb-2 text-xl font-bold dark:text-white">Relatório de Faturamento</h3>
                        <p className="text-gray-500 dark:text-gray-400">Visualize seus rendimentos para gerenciar melhor a sua empresa.</p>
                    </div>
                    <div>
                        <div className="flex justify-center items-center mb-4 w-10 h-10 rounded-full bg-primary-100 lg:h-12 lg:w-12 dark:bg-primary-900">
                            <Notepad size={32} color='#1C9AEA' weight='bold' />
                        ...
                        <h3 className="mb-2 text-xl font-bold dark:text-white">Orçamento</h3>
                        <p className="text-gray-500 dark:text-gray-400">Emita seus orçamentos de forma simples e compartilhe com seus clientes.</p>
                    </div>
                    <div>
                        <div className="flex justify-center items-center mb-4 w-10 h-10 rounded-full bg-primary-100 lg:h-12 lg:w-12 dark:bg-primary-900">
                            <Users size={32} weight="bold" color='#1C9AEA' />
                        ...
                        <h3 className="mb-2 text-xl font-bold dark:text-white">Cadastro de Clientes</h3>
                        <p className="text-gray-500 dark:text-gray-400">Controle da cartela de clientes com informações de contato, endereço e vínculo em Orçamentos.</p>
                    </div>
                </div>
            </div>
        </section>
