...
export function Navbar() {
    ...
    return (
        <div className="flex min-h-[h-screen] w-16 flex-col justify-between border-e bg-white dark:bg-slate-800">
            <div>
            ...
            <div className="border-t border-gray-100 dark:border-gray-500 bg-white dark:bg-slate-800 p-2">
                <div className="px-1">
                    <ModeToggle />
                </div>
